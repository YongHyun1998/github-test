...
$(function() {
  ...
  $(".mob-bug").click(function() {
    ...
    $(".mob-bug").toggleClass("on");
    $(".mobile-nav").toggleClass("on");
    $(".mob-search").removeClass("on");
    $(".mobile-nav-search").removeClass("on");
  }); 
  
  $(".mob-search").click(function() {
    $(".mob-search").toggleClass("on");
    $(".mobile-nav-search").toggleClass("on");
    $("html, body").removeClass("on");
    $(".mobile-nav").removeClass("on");
    $(".mob-bug").removeClass("on");
  });
});
